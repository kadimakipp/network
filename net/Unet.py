...
class UNet_FCN(nn.Module):
    def __init__(self, inc, classes):
        ...
        self.encode_4 = ConvEncode(inc=128, ouc=256)
        self.down_4 = ConvDownSample(inc=256, ouc=256)

        self.bottleneck = ConvDecode(inc=256, mic=512, ouc=256)
        self.up_4 = ConvDecode(512, 256, 128)
    ...
    def forward(self, x):
        ...
        level_4 = self.encode_4(downsample_3)
        downsample_4 = self.down_4(level_4)
        bottleneck1 = self.bottleneck(downsample_4)
        concat_level_4 = self.crop_and_concat(bottleneck1, level_4, crop=True)
        up_3 = self.up_4(concat_level_4)
        concat_level_3 = self.crop_and_concat(up_3,level_3,crop=True)
        up_2 = self.up_3(concat_level_3)
        concat_level_2 = self.crop_and_concat(up_2, level_2, crop=True)
        up_1 = self.up_2(concat_level_2)
        concat_level_1 = self.crop_and_concat(up_1, level_1, crop=True)
